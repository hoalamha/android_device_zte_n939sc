...
public class ZTEUiccRIL extends RIL implements CommandsInterface {
    protected boolean isGSM = false;

    public ZTEUiccRIL(Context context, int preferredNetworkType,
            int cdmaSubscription, Integer instanceId) {
        super(context, preferredNetworkType, cdmaSubscription, instanceId);
    }

    public ZTEUiccRIL(Context context, int networkMode, int cdmaSubscription) {
